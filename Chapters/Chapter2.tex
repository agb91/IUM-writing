...
In this project the role of aesthetics is cured only in the final version, immediately before tests this application with the final users:
In the first and intermediate versions we can observe some overlapping surfaces, some asymmetrical figures, and some others aesthetic problems, because in the design problems we thought first at the functionalities, but from the third version the interface is surely more pleasant and cured, because the aesthetics plays an important role in the satisfaction of the users.  

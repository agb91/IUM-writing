...
\thesistitle{Design and implementation of the interface "gAn Web"} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
